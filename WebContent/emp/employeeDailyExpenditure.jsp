...
function validate()
 {
	...
	if(!isNaN(  document.getElementById("employee_name").value )){
		...
		return false;
		 ...
		 {
		     alert( "plese Enter employee address !" ); 
		     return false;
		 } 
		 ...
		 if(isNaN(  document.getElementById("rs").value )){
		 ...
		 if((document.getElementById("rs").value).length<0)
			{
		        alert( "Please enter valid   rs can not be less than zero!" ); 
		        return false;
		    }
		 
		 if (/[^a-zA-Z0-9\-\/]/.test(document.getElementById("rs").value)) {
			    alert("special characters are not allowed in rs field");
			    return false;
			  }
		 ...
		 if (/[^a-zA-Z0-9\-\/]/.test(document.getElementById("description").value)) {
			    alert("description can only contain  characters,special characters are not allowed");
			    return false;
			  }
...
<form action="../DailyExpensesController" method="post" onsubmit="return(validate());">
       <h2 style="text-align:center;color:black">EMPLOYEE DAILY EXPENDITURE</h2>
       <table>
       <tr>
       <td>
           ...
           <div  style="margin-top:100px">
            ...
            <td>
           <div  style="margin-top:100px">
             <label style="margin-left: 30px;">RS</label><br>
             <input type="text" name="rs"  id="rs" style="margin-left: 10px;" maxlength="5">&nbsp;&nbsp;&nbsp;
           </div> 
           </td>
          ...
          <td>
           <div  style="margin-top:100px">
             <label style="margin-left: 30px;">Description</label><br>
             <input type="text" name="description" id="description" style="margin-left: 10px;" maxlength="200">&nbsp;&nbsp;&nbsp;
           </div> 
           </td>
           <td>
          ...
          <a href="employeeDailyExpFindRecord.jsp" style="color:black">FindRecord</a>
